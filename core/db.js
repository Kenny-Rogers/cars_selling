...
// module.exports =  {get_db, connect, get_primary_key, collection} ;
const mongoose = require('mongoose');
//mongoose.connect('mongodb+srv://car_selling_webapp:IfnPjZQiM367ABPc@cluster0-avv4c.mongodb.net/test?retryWrites=true');
const Schema = mongoose.Schema;
const ObjectId = Schema.ObjectId;

module.exports = {mongoose, Schema, ObjectId};